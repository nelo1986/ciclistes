...
class TestGenerarDataset(unittest.TestCase):
	...
	def test_longituddataset(self):
		...
		"""
		fitxer_sortida = 'data/temp_dataset.csv'  # Ruta temporal para el archivo

		arr = generar_dataset(200, 1, dicc[0], fitxer_sortida)
	...
	def test_valorsmitjatp(self):
		...
		arr = generar_dataset(100, 1, dicc[0],fitxer_sortida)
		#assertLess(a, b)
		#assertGreater(a, b)
	...
	def test_valorsmitjatb(self):
		...
		arr = generar_dataset(100, 1, dicc[1],fitxer_sortida)
